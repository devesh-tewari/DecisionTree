#Part 2: Decision Tree for categorical as well as numerical data
...
#The function 'build_decision_tree()' is also modified. If the best attribute chosen is numeric,
